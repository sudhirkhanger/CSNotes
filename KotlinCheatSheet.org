...
Kotlin implements Stack and Queue's using ArrayDeque. ArrayDeque is resizable double-ended queue, 
...
// peek - returs last element without removing
deque.last() // 3 or NoSuchElementException
//size
deque.size // 3
// isEmpty
deque.isEmpty() // false
...
/*
 * Queue - FIFO
 * dequeue <-- first/front 4-5-6-6-2-4 last/end <-- enqueue
 */

// enqueue - Adds an element to the end of the array
deque.addLast(0) // [1, 2, 3, 0]
// dequeue - Removes and returns the first element
deque.removeFirst() // [2, 3, 0]
